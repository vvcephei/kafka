...
//    private  final Logger logger;
    ...
    public PartitionGroup(final LogContext logContext,
...
//                     wallClockTime);
     ...
     */
    public int addRawRecords(final TopicPartition partition, final Iterable<ConsumerRecord<byte[], byte[]>> rawRecords) {
